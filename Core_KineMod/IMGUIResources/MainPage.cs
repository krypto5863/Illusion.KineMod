...
namespace Core_KineMod.IMGUIResources
{
	internal static class MainPage
	{
		...
		private static void DrawEndSection(MPCharCtrl mCharCtrl)
		{
			...
			fkNodeSizeSlider.value = GUILayout.HorizontalSlider(fkNodeSizeSlider.value, fkNodeSizeSlider.minValue,
				fkNodeSizeSlider.maxValue);
			GUILayout.Label("IK Node Size");
			ikNodeSizeSlider.value = GUILayout.HorizontalSlider(ikNodeSizeSlider.value, ikNodeSizeSlider.minValue,
				ikNodeSizeSlider.maxValue);
			GUILayout.EndVertical();
		}
